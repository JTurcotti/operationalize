...
Even more importantly, $\bar{\gamma}$ can be constrained to be a clearly \textit{interpretable} family of models, such as deciison trees. This modelling scenario would thus suffice to show the conditions under which nuanced causal queries may be answered by a composition of a human-comprehensible data and a human-comphrenensible decision procedure on that data - like a ``flowchart'' style classification.
