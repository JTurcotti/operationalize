...
Since ITrees represent a program's interactions with the environment in an entirely syntactically distinct way from the other internal details of the program or the environment, equivalence of environmental interactions (``equivalence up to Tau'') becomes much easier to reason about than in the general case in which details of a program, its interactions with the environment, and the environment are all entangled.
