...
Where $\eta$ (unit), creates point masses\footnote{alternatively interpreted as \textit{dirac deltas}, or geometrically, as complete and non-redundant indexing into the vertex set of the simplex $\P^\D$} and $\mu$ (join), collapses distributions of distributions to distributions\footnote{the feasibility of which is also described as the ``law of total probability''}.
